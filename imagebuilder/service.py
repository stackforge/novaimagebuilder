...
_ = excutils._
#from imagebuilder import conductor
from imagebuilder import context
from imagebuilder import exception
from imagebuilder.openstack.common import eventlet_backdoor
from imagebuilder.openstack.common import importutils
from imagebuilder.openstack.common import log as logging
from imagebuilder.openstack.common import loopingcall
from imagebuilder.openstack.common import rpc
#from imagebuilder import servicegroup
#from imagebuilder import utils
from imagebuilder import version
from imagebuilder import wsgi

LOG = logging.getLogger(__name__)

service_opts = [
    cfg.ListOpt('enabled_apis',
                default=['imagebuilder_api'],
                help='a list of APIs to enable by default'),
    cfg.ListOpt('enabled_ssl_apis',
                default=[],
                help='a list of APIs with enabled SSL'),
    cfg.StrOpt('imagebuilder-api_listen',
               default="0.0.0.0",
               help='IP address for imagebuilder API to listen'),
...
CONF.import_opt('host', 'imagebuilder.netconf')
...
class Service(object):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'imagebuilder-' part
        ...
        if not topic:
            topic = binary.rpartition('imagebuilder-')[2]
        if not manager:
            manager_cls = ('%s_manager' %
                           binary.rpartition('imagebuilder-')[2])
