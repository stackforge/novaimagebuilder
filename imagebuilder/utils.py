...
from imagebuilder import exception
from imagebuilder.openstack.common import excutils
from imagebuilder.openstack.common import importutils
from imagebuilder.openstack.common import log as logging
from imagebuilder.openstack.common import processutils
from imagebuilder.openstack.common.rpc import common as rpc_common
from imagebuilder.openstack.common import timeutils

notify_decorator = 'imagebuilder.openstack.common.notifier.api.notify_decorator'
...
monkey_patch_opts = [
    ...
    cfg.ListOpt('monkey_patch_modules',
                default=[
                  'imagebuilder.api.ec2.cloud:%s' % (notify_decorator),
                  'imagebuilder.compute.api:%s' % (notify_decorator)
                  ],
...
utils_opts = [
    ...
    cfg.StrOpt('rootwrap_config',
               default="/etc/imagebuilder/rootwrap.conf",
...
def execute(*cmd, **kwargs):
    ...
    if 'run_as_root' in kwargs and not 'root_helper' in kwargs:
        kwargs['root_helper'] = 'sudo imagebuilder-rootwrap %s' % CONF.rootwrap_config
...
def imagebuilderdir():
    import imagebuilder
    return os.path.abspath(imagebuilder.__file__).split('imagebuilder/__init__.py')[0]
...
def monkey_patch():
    ...
    Example:
      'imagebuilder.api.ec2.cloud:imagebuilder.openstack.common.notifier.api.notify_decorator'

    Parameters of the decorator is as follows.
    (See imagebuilder.openstack.common.notifier.api.notify_decorator)
...
def generate_mac_address():
    ...
    #             properly: 0xfa.
    #             Discussion: https://bugs.launchpad.net/imagebuilder/+bug/921838
    mac = [0xfa, 0x16, 0x3e,
